...
function About() {
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 lg:hidden bg-cover bg-center grayscale
        opacity-20 dark:opacity-25"
        style={{ backgroundImage: `url(${profileImg})` }}
      />

      {/* Mobile + Tablet Overlay */}
      <div className="absolute inset-0 lg:hidden bg-white/70 dark:bg-black/55" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <motion.p
          ...
          text-gray-500 dark:text-gray-400 mb-12"
        >
          About Me
        </motion.p>
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div>
            ...
            <motion.p
              ...
              text-base sm:text-lg leading-8 mb-6 max-w-xl"
            >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              className="text-gray-700 dark:text-gray-300
              text-base sm:text-lg leading-8 mb-8 max-w-xl"
            >
          ...
          >
            <div className="overflow-hidden rounded-3xl">
              <img
                src={profileImg}
                alt="Marvellous"
                className="w-full h-125 xl:h-150
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="lg:hidden absolute bottom-8 right-6 sm:right-10
          bg-white/90 dark:bg-gray-900/90
          backdrop-blur-sm
          px-5 py-3 rounded-full
          shadow-sm"
